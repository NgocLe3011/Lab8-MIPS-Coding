...
unsigned int read_dword(const char *base_address, int offset){
    ...
    unsigned int value = *(unsigned int *)(base_address + offset);

    printf("DWORD at %p = %08Xh\n", base_address + offset, value);
...
const unsigned char *ptr = (unsigned char *)(base_address + offset);

    printf("\nMemory Dump starting at offset %08Xh\n", offset);
    printf("------------------------------------------------------------\n");
